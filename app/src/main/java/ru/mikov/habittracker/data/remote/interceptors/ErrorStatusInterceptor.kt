...
import ru.mikov.habittracker.data.remote.NetworkManager.moshi
import ru.mikov.habittracker.data.remote.err.ApiError
import ru.mikov.habittracker.data.remote.res.ErrorRes
...
class ErrorStatusInterceptor : Interceptor {
    override fun intercept(chain: Interceptor.Chain): Response {
        ...
        val errMessage = try {
            moshi.adapter(ErrorRes::class.java).fromJson(res.body!!.string())?.message
